...
public class ProgressRing extends View {
    ...
    public ProgressRing(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        ta = context.obtainStyledAttributes(attrs, R.styleable.ProgressRing);
        rr();
    }

    public ProgressRing(Context context,AttributeSet attrs, int defStyle) {
        super(context, attrs);
        mContext = context;
        ta = context.obtainStyledAttributes(attrs, R.styleable.ProgressRing);
        rr();
